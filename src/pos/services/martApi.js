...
// /**
//  * Maps a backend ProductResponse to the shape AdminMart expects.
//  * Backend: { id, name, cat, price, stock }
//  */
...
//   /** GET /mart/products — returns mapped product array */
//   async getAll() {
//     const { data } = await api.get("/mart/products");
//     return data.map(mapProduct);
//   },

//   /** GET /mart/categories — returns string array */
//   async getCategories() {
...
//   /**
//    * POST /mart/products — create a new product.
//    * @param {{ name, cat, price, stock }} product
//    */
//   async create(product) {
//     const { data } = await api.post("/mart/products", {
//       name:  product.name,
//       cat:   product.cat,
...
//   /**
//    * PUT /mart/products/:id — update existing product.
//    * @param {number} id
//    * @param {{ name, cat, price, stock }} product
//    */
//   async update(id, product) {
//     const { data } = await api.put(`/mart/products/${id}`, {
//       name:  product.name,
//       cat:   product.cat,
//       price: parseFloat(product.price),
//       stock: parseInt(product.stock),
...
// /**
//  * Maps a backend ProductResponse to the shape AdminMart expects.
//  * Backend field is "category", frontend uses "cat" throughout.
//  */
// export function mapProduct(p) {
//   return {
//     id:    p.id,
//     name:  p.name,
//     cat:   p.category ?? p.cat,  // handle whichever field the backend returns
//     price: p.price,
//     stock: p.stock,
//   };
// }
...
//   /**
//    * POST /mart/products
//    * @param {{ name, cat, price, stock }} product - frontend shape
//    */
//   async create(product) {
//     const { data } = await api.post("/mart/products", {
//       name:     product.name,
//       category: product.cat,          // ProductRequest uses "category"
//       price:    parseFloat(product.price),
//       stock:    parseInt(product.stock),
//     });
//     return mapProduct(data);
...
// /**
//  * Maps a backend ProductResponse to the frontend shape.
//  * Backend: { id, name, category, price, stock }
//  * Frontend: { id, name, cat, price, stock }
//  */
// function mapProduct(p) {
//   return {
//     id:    p.id,
//     name:  p.name,
//     cat:   p.category,   // backend = "category", frontend = "cat"
//     price: p.price,
//     stock: p.stock,
//   };
// }
...
//  * Translates frontend "cat" → backend "category".
//  */
// function toRequest(product) {
//   return {
//     name:     product.name,
//     category: product.cat,             // frontend "cat" → backend "category"
//     price:    parseFloat(product.price),
//     stock:    parseInt(product.stock),
//   };
// }
...
//   /** POST /mart/products */
//   async create(product) {
//     const { data } = await api.post("/mart/products", toRequest(product));
//     return mapProduct(data);
//   },

//   /** PUT /mart/products/:id */
//   async update(id, product) {
//     const { data } = await api.put(`/mart/products/${id}`, toRequest(product));
//     return mapProduct(data);
//   },
...
//   /** GET /mart/categories — returns string[] */
//   async getCategories() {
//     const { data } = await api.get("/mart/categories");
//     return data;
//   },
